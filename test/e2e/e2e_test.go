...
// namespace where the project is deployed in. Setup/teardown is owned by
// e2e_suite_test.go's BeforeSuite/AfterSuite so multiple Describes can share
// the same operator deployment.
const namespace = operatorNamespace
